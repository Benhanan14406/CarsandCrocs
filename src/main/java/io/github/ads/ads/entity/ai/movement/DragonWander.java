...
public class DragonWander extends Goal {
    ...
    public DragonWander(AbstractDragon creatureIn, double speedIn) {
        this(creatureIn, speedIn, 20);
    }

    public DragonWander(AbstractDragon creatureIn, double speedIn, int chance) {
